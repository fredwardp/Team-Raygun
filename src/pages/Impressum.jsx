const Impressum = () => {
  return (
    <div className="formal_texts_wrapper">
      <header className="formal_texts_header">
      ...
      <main className="container formal_texts_main">
        ...
        <article>
          <p>
            Informationen zum Datenschutz und zur Datensicherheit beim Besuch
            dieser Webseite finden Sie in der
            <span>
